...
const EditarMonedas = ({setSeccionTitle}) => {
    useEffect(() => {
        setSeccionTitle('Editar Moneda');
        document.title = `Banco Pide Ya - Editar Moneda`;
        obtenerMoneda();
    }, []);
    ...
    const [datos, setDatos] = useState({
      ...
      const obtenerMoneda = async() => {
        helpAxios(true).get('/api/monedas/obtenerMoneda/'+moneda)
          .then(function ({data}) {
            setDatos(data);
          })
      ...
      const hanndleSubmit = async(e) => {
            ...
            helpAxios(true).put('/api/monedas/actualizaMoneda/'+moneda, datos)
                .then(function (response) {
                console.log(response);
                Swal.fire( 
                    'Actualización Exitosa',
                    'Actualización de moneda correctamente',
                    'success')
                    .then((respuesta) =>{
